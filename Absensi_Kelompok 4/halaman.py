...
def show_home():
    st.title("Facial Recognition-Based Attendance System with MySQL Database Integration")
    ...
    st.markdown(
       ...
       ### AI Project Cycle
        ...
        2. **Absen**: Pengguna melakukan login dengan memverifikasi wajah mereka.
        3. **Agree**: Kehadiran dicatat berdasarkan verifikasi wajah.
        4. **process class**: Menampilkan data pengguna dan kehadiran.
       """,
